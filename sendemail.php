...
$emailSubject = 'Hotel Reservations!';
...
$numberofRooms =$_POST['number-of-rooms'];
$numberofAdults = $_POST['number-of-adults'];
$checkindate = $_POST['check-in-date'];
$checkinmonth = $_POST['check-in-month'];
$checkinyear = $_POST['check-in-year'];
...
<b>check in Month:</b> $checkinmonth <br>
<b>Check in Year:</b> $checkinyear <br>
...
<div class="jumbotron">
  ...
  <p>Thanks for choosing Wise Penny Suites and Spa, we would get back to you in a moment through your email $emailField</p>
...
<div class="text-center copyright">Powered by <a href="http://pointxt.com">PointX Solutions</a></div>
