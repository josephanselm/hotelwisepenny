...
$emailSubject = 'Hotel Subscriptions!';
$webMaster = 'reservations@hotelwisepennysuites.com';

/*Gathering Data Variables*/

$subscriptionField = $_POST['subscriptions'];
...
$body =<<<EOD
<br><hr><br>
<b>Email:</b> $subscriptionField <br>
EOD;


	$header = "From: $subscriptionField\r\n";
...
<div class="jumbotron">
  ...
  <p>Thanks for choosing Wise Penny Suites and Spa, we would always notify about new things about hospitality through your email $subscriptionfield</p>
